...
def comprobarConsanginidad(idHabitante):
    esMiPadre(idHabitante)
    esMiHijo(idHabitante)  
    esMiAbuelo(idHabitante)
    esMiNieto(idHabitante) 
    esMiHermano(idHabitante)
    esMiTio(idHabitante)
    esMiSobrino(idHabitante)
    esMiBisabuelo(idHabitante)
    esMiBisnieto(idHabitante)
    esMiTataraabuelo(idHabitante)
    esMiTataranieto(idHabitante)
    esMiTioAbuelo(idHabitante)
    esMiPrimo(idHabitante)
    esMiSobrinoNieto(idHabitante)
    esMiTrastataraAbuelo(idHabitante)
    esMiTrastaranieto(idHabitante)
    esMiTioBisabuelo(idHabitante)
    esMiTioSegundo(idHabitante)
    esMiSobrinoSegundo(idHabitante)
    esMiSobrinoBisnieto(idHabitante)
    esMiPentabuelo(idHabitante)
    esMiPentanieto(idHabitante)
    esMiTioTataraabuelo(idHabitante)

    
comprobarConsanginidad(16)"""